...
The corresponding results for the DistilBERT model is further shown below
![distilbert training](https://github.com/olof98johansson/SentimentAnalysisNLP/blob/main/distilBERT_plots/8_epoch_train.pdf?raw=true)
